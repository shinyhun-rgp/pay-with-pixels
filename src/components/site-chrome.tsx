    ...
    <header className="relative border-b border-border">
      <div className="relative overflow-hidden">
        ...
        <div
          ...
          style={{
            background:
              "radial-gradient(900px 320px at 15% -20%, oklch(1 0 0 / 0.06), transparent 70%), radial-gradient(700px 300px at 90% 0%, oklch(1 0 0 / 0.04), transparent 70%)",
          }}
        />
  ...
  return (
    <div className="min-h-screen relative flex flex-col">
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(1000px 500px at 80% -10%, oklch(1 0 0 / 0.06), transparent 70%), radial-gradient(900px 500px at 0% 100%, oklch(1 0 0 / 0.04), transparent 70%)",
        }}
      />
      <SiteHeader />
